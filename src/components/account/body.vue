        ...
        <script>
            export default {
                data() {
                    return {
                        data:[
                            {"id":"1","name":"Сиыр еті - Говядина", "amount":"15-23кг","cost":"1700тг/кг","image":require("../../assets/images/cow.jpg"),"count":1}, 
                            {"id":"2","name":"Жылқы еті - Конина", "amount":"17-25кг","cost":"1800тг/кг","image":require("../../assets/images/horse.jpg"),"count":1},
                            ...
                            {"id":"5","name":"Саумал", "amount":"1-шт/1 дана","cost":"1000тг/1,5л","image":require("../../assets/images/kymyz.jpg"),"count":1},
